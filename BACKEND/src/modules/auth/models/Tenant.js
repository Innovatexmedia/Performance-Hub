...
export const PLAN_LIMITS = Object.freeze({
  free:       { maxUsers: config.PLAN_MAX_USERS_FREE,       maxLeads: 250,    maxCampaigns: 3   },
  starter:    { maxUsers: config.PLAN_MAX_USERS_STARTER,    maxLeads: 1000,   maxCampaigns: 10  },
  growth:     { maxUsers: config.PLAN_MAX_USERS_GROWTH,     maxLeads: 10000,  maxCampaigns: 50  },
  scale:      { maxUsers: config.PLAN_MAX_USERS_SCALE,      maxLeads: 50000,  maxCampaigns: 200 },
  enterprise: { maxUsers: config.PLAN_MAX_USERS_ENTERPRISE, maxLeads: 999999, maxCampaigns: 999 },
});
